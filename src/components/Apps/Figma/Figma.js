...
const Figma = () => {
	...
	const herokuURL =
		"https://www.figma.com/oauth?client_id=V2IvPlEApDfBT9uNS5Rbrf&redirect_uri=https://zurichatappfigma.herokuapp.com/authenticate/&scope=file_read&state=state&response_type=code";
	return (
		<div>
